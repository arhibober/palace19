...
if ($this->tmpl['displayimagecategoriescv'] == 1) {	
	...
	for ($i = 0; $i < $countCategories; $i++) {
		...
		echo '<tr>';		
		echo '<td align="center" valign="middle" style="'.$this->tmpl['imagebgcv'].';text-align:center; border-width: 0px;border:none none; border-color: #ffffff !important;"><a href="'.$this->itemscv[$i]->link.'">';
		if (isset($this->itemscv[$i]->extpic) && $this->itemscv[$i]->extpic) {
		...
		echo '</a></td>';
		echo '<td style="border-width: 0px;border:none none; border-color: #ffffff !important;"><a href="'.$this->itemscv[$i]->link.'">'.$this->itemscv[$i]->title.'</a>&nbsp;';
