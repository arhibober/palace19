		...
		<a href="<?php if ($this->params->get( 'url5' )) : ?><?php echo ($url5); ?><?php endif; ?>">
			<img src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/slideshow/5.jpg" title="<?php if ($this->params->get( 'slidedesc5' )) : ?><?php echo ($slidedesc5); ?><?php endif; ?>" height="250" width="500" /></a>
		<a href="<?php if ($this->params->get( 'url6' )) : ?><?php echo ($url6); ?><?php endif; ?>">
			<img src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/slideshow/6.jpg" title="<?php if ($this->params->get( 'slidedesc6' )) : ?><?php echo ($slidedesc6); ?><?php endif; ?>" height="250" width="500" /></a>
		</div>